...
function ReadableStreamClose(stream) {
    ...
    if (IsReadableStreamDefaultReader(reader)) {
        for (var _i = 0, _a = reader._readRequests; _i < _a.length; _i++) {
            var _resolve = _a[_i]._resolve;
...
function ReadableStreamError(stream, e) {
    ...
    if (IsReadableStreamDefaultReader(reader)) {
        for (var _i = 0, _a = reader._readRequests; _i < _a.length; _i++) {
            var readRequest = _a[_i];
            readRequest._reject(e);
        }
        reader._readRequests = [];
    }
    else {
        for (var _b = 0, _c = reader._readIntoRequests; _b < _c.length; _b++) {
            var readIntoRequest = _c[_b];
